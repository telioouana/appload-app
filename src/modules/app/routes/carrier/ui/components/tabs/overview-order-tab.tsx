...
export function OverviewOrderTab({ values }: { values: OrderValues }) {
    const t = useTranslations("Carrier.order.dialog.details.tabs.content.overview")
    const f = useFormatter()

    const { cargo, order } = values
