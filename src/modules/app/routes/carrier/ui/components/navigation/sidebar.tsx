...
export function CarrierSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
    ...
    const t = useTranslations("Carrier.sidebar")
    ...
    const marketplace = [
        ...
        {
            label: t("content.marketplace.trips.label"),
            url: "/c/trips",
            Icon: IconRoute,
            items: [
                {
                    label: t("content.marketplace.trips.all"),
                    url: "/c/trips/all",
                    Icon: IconTruckLoading,
                },
                {
                    label: t("content.marketplace.trips.booked"),
                    url: "/c/trips/booked",
                    Icon: IconLock,
                },
                {
        ...
        {
            label: t("content.marketplace.history"),
            url: "/c/history",
            Icon: IconHistory,
        },
        {
            label: t("content.marketplace.clients"),
            url: "/c/clients",
    ...
    const company = [
        {
            label: t("content.company.label"),
            url: "/c/company",
            Icon: IconBuildingFactory,
            items: [
                {
                    label: t("content.company.drivers"),
                    url: "/c/company/drivers",
                    Icon: IconUsers,
                },
                {
                    label: t("content.company.fleet"),
                    url: "/c/company/fleet",
                    Icon: IconTruck,
                }
            ]
