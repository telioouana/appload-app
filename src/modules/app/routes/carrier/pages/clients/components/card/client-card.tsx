...
import { ClientValues } from "../../../../types/types";
...
export function ClientCard({ values }: Props) {
    const t = useTranslations(`Carrier.clients.card`)
    const f = useFormatter()

    const { name, logo, address, trips, revenue, } = values
