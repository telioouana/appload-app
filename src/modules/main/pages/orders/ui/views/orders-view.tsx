...
import { OrdersHeaderSection } from "../sections/orders-header-section"
            ...
            <ErrorBoundary fallback={<OrdersErrorFallback />}>
                <div className="w-full h-full flex flex-col gap-y-6">
                    <div className="flex flex-col gap-4 h-full w-full p-4">
                        ...
                        <OrdersListSection filter={filter} source={source} userType={userType} orders={data.pages[0].items} />
