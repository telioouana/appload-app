...
import { IconBell, IconHelpCircle, IconLogout, IconSelector, IconSettings, IconUser } from "@tabler/icons-react";
...
export function Header() {
    ...
    const t = useTranslations("Shipper.main.header")
