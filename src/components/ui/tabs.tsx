    ...
    return (
        <TabsPrimitive.Trigger
            ...
            className={cn(
                ...
                "data-active:bg-primary data-active:text-primary-foreground dark:data-active:text-primary-foreground dark:data-active:border-input dark:data-active:bg-primary",
