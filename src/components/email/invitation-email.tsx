...
export async function InvitationEmail({ url, inviter, organization }: Props) {
                ...
                <Body className="font-sans">
                    <Container className="mx-auto px-4 py-5">
                        ...
                        <Section className="mt-8">
                            <Text className="text-2xl font-bold">{t("greeting")}</Text>
                        </Section>

                        <Section className="mt-2">
                            <Text className="text-base">{t("intro", { organization: organization})}</Text>
                        </Section>

                        <Section className="mt-2">
                            <Text className="text-base">{t("inviter", { inviter: inviter})}</Text>
                        </Section>
