...
export const TripSchema = z.object({
    ...
    truckPlate: z.string(),
    truckAge: z.enum(TRUCK_AGE),
    trailerPlate: z.string().nullable(),
    linkPlate: z.string().nullable(),

    proposedLoadingDate: z.date(),
    arrivalAtLoading: z.date().optional(),
    arrivalOnTimeLoading: z.boolean().optional(),
    actualLoadingDate: z.date().optional(),
    departureLoadingDate: z.date().optional(),
    daysSpendLoading: z.number().optional(),

    daysSpendTraveling: z.number().optional(),

    proposedOffloadingDate: z.date(),
    arrivalAtOffloading: z.date().optional(),
    arrivalOnTimeOffloading: z.boolean().optional(),
    actualOffloadingDate: z.date().optional(),
    departureOffloadingDate: z.date().optional(),
    daysSpendOffloading: z.number().optional(),

    demurageCharged: z.boolean().optional(),
    totalDemurageChargedDays: z.number().optional(),
    arrivalAtBorder: z.date().optional(),
    departureFromBorder: z.date().optional(),

    loadedWeight: z.string().optional(),
    offloadedWeight: z.string().optional(),
    weightUnit: z.enum(WEIGHT_UNIT).optional(),

    tripType: z.enum(TRIP_TYPE).optional(),
    deliveries: z.number().optional(),
    podStatus: z.enum(POD_STATUS).optional(),
    status: z.enum(TRIP_STATUS),

    carrierInvoiceNumber: z.string().optional(),
    carrierInvoiceDate: z.date().optional(),
    fiscalRegime: z.enum(FISCAL_REGIME).optional(),
    carrierSubtotal: z.string(),
    carrierVAT: z.string(),
    carrierTotal: z.string(),
    carrierCurrency: z.enum(CURRENCY).optional(),
    carrierPaidPartially: z.string().optional(),
    carrierPaidAmount: z.string().optional(),
    carrierPaidPercentage: z.string().optional(),
    carrierPaymentStatus: z.enum(PAYMENT_STATUS),
    carrierRemainingAmount: z.string().optional(),
    carrierRemainingPercentage: z.string().optional(),
    carrierFullPaymentDate: z.date().optional(),

    insuranceSubscriber: z.string().optional(),
    insuranceValue: z.string().optional(),
    insuranceCurrency: z.enum(CURRENCY).optional(),
    insuranceStatus: z.enum(INSURANCE_PAYMENT_STATUS).optional(),
    ...
    shipperInvoiceDate: z.date().optional(),
    shipperSubtotal: z.string(),
    shipperVAT: z.string(),
    shipperTotal: z.string(),
    shipperCurrency: z.enum(CURRENCY).optional(),
    shipperPaidPartially: z.string().optional(),
    shipperPaidAmount: z.string().optional(),
    shipperPaidPercentage: z.string().optional(),
    shipperPaymentStatus: z.enum(PAYMENT_STATUS),
    shipperRemainingAmount: z.string().optional(),
    shipperRemainingPercentage: z.string().optional(),
    shipperFullPaymentDate: z.date().optional(),

    ageFactor: z.string(),
    loadFactor: z.string(),
    defaultCoefficient: z.string(),
    totalFuelCost: z.string(),
})
...
export type TripSchemaFrom = z.infer<typeof TripSchema>
